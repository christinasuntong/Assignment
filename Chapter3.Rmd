...
For the $i$th fitted value takes the form $y_i=X_i\beta$, where $\beta= \frac{\sum{x_i y_i}}{\sum{x_j^2}}$. And$y_i=\sum{a_j y_j}$. We have,$y_i= X_i\beta=X_i \frac{\sum{x_i y_i}}{\sum{x_j^2}}=\sum{\frac{x_j x_i}{\sum{x_k^2}}} y_j$
